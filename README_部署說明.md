...
`update-data.yml` 已設定每個交易日（週一到週五）自動跑兩班：
台灣時間 **15:30**（盤後主班，等證交所量價與三大法人 T86 資料定稿後才抓）與
**隔日清晨 06:00**（補抓班，補上前一晚還沒定稿的法人資料）。
你什麼都不用做，之後每天盤後熱力圖會自己更新。
...
- [ ] 美股 / 韓股 / 日股（再下一步，資料源不同）→ 實作藍圖見 `Phase3_多市場管線設計.md`
